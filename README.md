...
python scripts/train_residual.py \
  ...
  --residual_alpha 0.25 \
  --residual_alpha_warmup_steps 6000 \
  --residual_alpha_warmup_min 0.15 \
  --residual_delta_clip 0.30 \
  --residual_std_min 0.12 \
  --residual_std_max 0.45 \
  --reset_residual_std 0.30
